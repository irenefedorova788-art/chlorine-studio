...
export const content: Record<Locale, Dict> = {
  ru: {
      ...
      items: [
        {
          code: "Au",
          title: "Аудит бренда",
          desc: "Позиционирование, визуальный язык, коммуникация, точки контакта.",
          long: "Разбираем, как бренд выглядит сейчас: позиционирование, визуальный язык, коммуникация, точки контакта и то, насколько всё это работает на нужную аудиторию. На выходе — конкретные точки роста и направление, в котором бренду стоит двигаться.",
          includes: [
            "Позиционирование",
            "Визуальный язык",
            "Коммуникация",
        ...
        },
        {
          ...
          desc: "Позиционирование, визуальная территория, tone of voice.",
          long: "На основе аудита формируем характер бренда: позиционирование, визуальную территорию, tone of voice и основные принципы коммуникации. Здесь же можно делать визуальную концепцию, moodboard, creative direction — то есть определить, каким бренд должен быть, прежде чем собирать его руками.",
          includes: [
            "Позиционирование",
            "Визуальная территория",
            "Tone of voice",
            "Moodboard и creative direction",
          ],
        },
        {
          code: "Vs",
          title: "Визуальная система",
          desc: "Айдентика, типографика, цвет, графические принципы.",
          long: "Визуальная система бренда и её применение: айдентика, типографика, цвет, графические принципы, key visuals, кампании, сезонные запуски и другие коммуникационные материалы.",
          includes: [
            "Айдентика и типографика",
            "Ключевые визуалы (key visuals)",
            "Кампании и сезонные запуски",
        ...
        },
        {
          code: "Ad",
          title: "Арт-дирекция",
          desc: "Концепция, дизайн, съёмка, продакшен — единый характер.",
          long: "Задаём визуальное направление и следим за тем, как оно воплощается. От концепции и визуальных решений до работы с дизайном, съёмкой и продакшеном — собираем всё в единый характер.",
          includes: [
    ...
    servicesPage: {
      ...
      headingMark: "помогаю",
      intro: "Четыре направления, которые я обычно веду сама, от начала до передачи. Комбинация зависит от того, что реально нужно бренду прямо сейчас.",
      back: "← На главную",
  ...
  en: {
      ...
      items: [
        {
          code: "Au",
          title: "Brand Audit",
          desc: "Positioning, visual language, communication, touchpoints.",
          long: "We break down how the brand looks today: positioning, visual language, communication, touchpoints, and how well all of it works for the right audience. The result is concrete growth points and a direction for the brand to move in.",
          includes: [
            "Positioning",
            "Visual language",
            "Communication",
        ...
        },
        {
          ...
          desc: "Positioning, visual territory, tone of voice.",
          long: "Based on the audit, we shape the brand's character: positioning, visual territory, tone of voice, and the core principles of communication. This is also where we build the visual concept, moodboard, and creative direction — defining what the brand should be before building it by hand.",
          includes: [
            "Positioning",
            "Visual territory",
            "Tone of voice",
        ...
        },
        {
          code: "Vs",
          title: "Visual System",
          desc: "Identity, typography, color, graphic principles.",
          long: "The brand's visual system and how it's applied: identity, typography, color, graphic principles, key visuals, campaigns, seasonal launches, and other communication materials.",
          includes: [
            "Identity & typography",
            "Key visuals",
        ...
        },
        {
          code: "Ad",
          title: "Art Direction",
          desc: "Concept, design, shoots, production — one character.",
          long: "We set the visual direction and make sure it's carried through. From concept and visual decisions to design, shoots, and production — bringing it all together into one consistent character.",
          includes: [
            "Visual direction",
            "Design",
            "Shoots",
    ...
    servicesPage: {
      ...
      headingMark: "do",
      intro: "Four things I usually run myself, start to handover. The mix depends on what the brand actually needs right now.",
      back: "← Back home",
