      ...
      items: [
        {
          ...
          desc: "Экспертное сопровождение стратегических партнёрств и маркетинговая поддержка быстрорастущих спортивных платформ.",
          long: "Мы предоставляем экспертное сопровождение стратегических партнёрств и маркетинговую поддержку быстрорастущим спортивным платформам.",
          includes: [],
        },
        {
          code: "02",
          title: "Экспириенс-решения",
          desc: "Команда экспертов в области мероприятий, развлечений, гостеприимства, инфраструктуры и брендинга.",
          long: "Наша команда экспертов в области мероприятий, развлечений, гостеприимства, инфраструктуры и брендинга создаёт уникальный бренд-опыт.",
          includes: [],
        },
        {
          code: "03",
          title: "Креативные решения",
          desc: "От идеи до реализации — креатив и дизайн для эмоциональной коммуникации с мощным воздействием.",
          long: "От идеи до реализации: мы соединяем креатив и дизайн, чтобы создавать эмоциональную коммуникацию с мощным воздействием.",
          includes: [],
        },
        {
          code: "04",
          title: "Управление проектами",
          desc: "От концепции до завершения — эффективно, точно и с высочайшим качеством.",
          long: "От концепции до завершения: мы управляем проектами эффективно, точно и с высочайшим качеством.",
          includes: [],
        },
        {
          code: "05",
          title: "Контент и продакшен",
          desc: "Создаём визуальный и текстовый контент в разных форматах.",
          long: "Мы создаём визуальный и текстовый контент в разных форматах.",
          includes: [],
        },
      ],
    },
      ...
      items: [
        {
          ...
          desc: "We offer expert guidance on strategic partnerships and provide marketing support for rapidly expanding sport platforms.",
          long: "We offer expert guidance on strategic partnerships and provide marketing support for rapidly expanding sport platforms.",
          includes: [],
        },
        {
          code: "02",
          title: "Experiential Solutions",
          desc: "Our team of experts for events, entertainment, hospitality, infrastructure and branding delivers one-of-a-kind brand experiences.",
          long: "Our team of experts for events, entertainment, hospitality, infrastructure and branding delivers one-of-a-kind brand experiences.",
          includes: [],
        },
        {
          code: "03",
          title: "Creative Solutions",
          desc: "From idea to production: We blend creativity and design to create emotional communication with powerful impact.",
          long: "From idea to production: We blend creativity and design to create emotional communication with powerful impact.",
          includes: [],
        },
        {
          code: "04",
          title: "Project Management",
          desc: "From concept to completion: we manage projects efficiently, precisely and with the highest quality.",
          long: "From concept to completion: we manage projects efficiently, precisely and with the highest quality.",
          includes: [],
        },
        {
          code: "05",
          title: "Content & Production",
          desc: "We create visual and text content in different formats.",
          long: "We create visual and text content in different formats.",
          includes: [],
        },
      ],
    },
